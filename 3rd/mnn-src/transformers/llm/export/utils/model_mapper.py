...
class ModelMapper:
    ...
    def regist_minicpmv4_6(self):
        """Map MiniCPM-V 4.6's Qwen3.5 text backbone for LLM export.

        The visual tower is exported separately because MiniCPM-V 4.6 uses a
        different vision tower/merger layout from Qwen3.5-VL.
        """
        minicpmv4_6_config = {
            'hidden_size': 'text_config.hidden_size',
            'head_dim': 'text_config.head_dim',
        ...
        self.regist('minicpmv4_6', {
            'config': minicpmv4_6_config,
            'model': minicpmv4_6_model,
            'decoder': self.default_decoder,
            'attention': self.default_attention,
            'linear_attention': minicpmv4_6_linear_attention,
        })
